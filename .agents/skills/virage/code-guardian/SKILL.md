...
when_to_use:
  ...
  - "Resolving lint or type-check errors before a commit"
  - "Auditing a PR for vulnerabilities or anti-patterns"
  - "Checking whether a change violates an active guardrail"
prerequisites: []
estimated_tokens: 2012
output_format: "Ordered list of findings with severity, file reference, and remediation action"
metadata:
