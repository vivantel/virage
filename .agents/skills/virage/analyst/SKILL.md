...
license: MIT
when_to_use:
  - "Diagnosing a pipeline failure or unexpected output"
  - "Interpreting virage evaluate / virage benchmark results"
  - "Checking vector store stats, cache hit rates, or search latency"
  - "Analyzing telemetry to measure indexing or retrieval performance"
prerequisites: []
estimated_tokens: 1061
output_format: "Diagnosis summary with root cause, metrics table, and recommended next action"
metadata:
