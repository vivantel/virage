...
[ ] New skill file added or renamed
      ...
      → packages/virage-skills/skills/ (copy updated SKILL.md — this is the distributable source)

[ ] Skill file content changed in .agents/skills/
      → packages/virage-skills/skills/<skill-name>/SKILL.md (keep in sync — virage-skills is the distributable copy)
