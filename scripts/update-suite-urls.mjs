#!/usr/bin/env node
// Patches eval/suites/retrieval-quality.suite.json with new GitHub release download URLs, SHA-256 digests,
...
const suiteRaw = readFileSync('eval/suites/retrieval-quality.suite.json', 'utf8');
...
writeFileSync('eval/suites/retrieval-quality.suite.json', JSON.stringify(suite, null, 2) + '\n');
console.log('\neval/suites/retrieval-quality.suite.json updated.');
